      ...
      : super(
          ...
          builder: (FormFieldState<String> field) {
            ...
            return Container(
                ...
                margin: useMargin ? EdgeInsets.symmetric(vertical:15.h) :  EdgeInsets.symmetric(vertical:0),
              child: Column(
                ...
                children: [
                  ...
                  if (!headerLess)
                    Text(
                      header ?? "",
                      style: TextStyle(color: red, fontWeight: FontWeight.w600, fontSize: 13.sp),
                    ),
                  SizedBox(height: 8),
                  Container(
